...
public class CreateProyectoFinalData {
	public void createTestData() throws PersistentException {
		...
		try {
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : da_megusta_, amigo_de, da_megusta, amigo, permiso, perfil_oculto, recibir_por_correo, recibir_notificacion
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : reportado_por, reporta, baneado, motivo
