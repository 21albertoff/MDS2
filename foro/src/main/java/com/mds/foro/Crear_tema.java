...
public class Crear_tema extends Crear_tema_Ventana {
	...
	public void guardar_tema() {
		...
		if (tituloTemas.getValue() == null || tituloTemas.getValue() == "" || descripcionTema.getValue() == null
				|| descripcionTema.getValue() == "") {
			Notification.show("Todos los campos son obligatorios", "", Notification.Type.ERROR_MESSAGE);
		} else {
			uni.guardar_tema(Parametros.getIdSeccion(), Parametros.getIdUsuario(), tituloTemas.getValue(),
					descripcionTema.getValue());
