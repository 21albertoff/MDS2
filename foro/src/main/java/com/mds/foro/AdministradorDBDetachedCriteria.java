...
public class AdministradorDBDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public Usuario_registradoDBDetachedCriteria createConvierte_en_moderadorCriteria() {
		return new Usuario_registradoDBDetachedCriteria(createCriteria("ORM_convierte_en_moderador"));
	}
	
	public Usuario_registradoDBDetachedCriteria createBaneaCriteria() {
		return new Usuario_registradoDBDetachedCriteria(createCriteria("ORM_banea"));
	}
