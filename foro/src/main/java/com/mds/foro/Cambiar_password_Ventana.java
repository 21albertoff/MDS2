...
public class Cambiar_password_Ventana extends AbsoluteLayout {
	...
	protected PasswordField campoPasswordRepetir;
	protected Button cancelarCambio;
	protected Label cambiarcontrasena;
	protected PasswordField campoPassword;
	protected Button confirmarCambio;
	protected Image logoIniciarSesion;

	public Cambiar_password_Ventana() {
		Design.read(this);
	}
}
